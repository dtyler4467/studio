      ...
      <main className="flex flex-1 flex-col gap-4 p-4 md:gap-8 md:p-8">
        <Card>
            <CardHeader>
                ...
                <CardDescription>
                    This section contains trailers that were moved from a lane that was already occupied. You can move them to an available lane or process their check-out from here.
                </CardDescription>
            </CardHeader>
            <CardContent>
                <LostAndFoundTable />
